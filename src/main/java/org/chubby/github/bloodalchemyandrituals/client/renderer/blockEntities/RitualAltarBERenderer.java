...
public class RitualAltarBERenderer implements BlockEntityRenderer<RitualAltarBlockEntity> {
    public RitualAltarBERenderer(BlockEntityRendererProvider.Context context) {

    }

    @Override
    public void render(RitualAltarBlockEntity pBlockEntity, float pPartialTick, @NotNull PoseStack pPoseStack,
